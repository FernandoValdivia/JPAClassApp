...
import practicejpa.entities.*;
import practicejpa.enums.DiaDeLaSemana;
import practicejpa.respositories.*;
...
public class JPAServices {
    ...
    public void cargarBase() {
        ...
        profesor1.setNombre("Linder");
        profesor1.setApellido("Hassinger");
        ...
        List<Profesor> profesor22 = profesorRepositorio.buscarPorNombre("Linder");
        //get(0) para quedarnos con el primer profesor de la lista
