...
import practicejpa.entities.Profesor;
...
public class ProfesorRepositorio extends RepositorioJPA<Profesor>{
    ...
    public List<Profesor> listarProfesores() {
        super.conect();
        List<Profesor> profesores = em.createNamedQuery("Profesor.listarProfesores").getResultList();
        super.disconect();
        return profesores;
    }
    ...
    public List<Profesor> buscarPorNombre(String nombre) {
        ...
        List<Profesor> profesor = 
                em.createQuery("SELECT p FROM Profesor p WHERE p.nombre = :nombre", Profesor.class).setParameter("nombre", nombre)
                .getResultList();
        super.disconect();
        return profesor;
    }
